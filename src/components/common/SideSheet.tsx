...
export default function SideSheet({
  ...
  const getButtonStyles = (isActive: boolean) => {
    const base = "self-stretch px-5 py-3 inline-flex justify-start items-center gap-2 transition-colors";
    
    if (isActive) {
      return `${base} bg-grayscale-gy100 text-primary-sg600`; // 활성 상태 (민트색)
    }
    return `${base} bg-grayscale-white text-grayscale-black hover:bg-grayscale-gy100`; // 기본 상태
  };
  ...
  return (
    ...
    >
      ...
      <div className="self-stretch flex flex-col justify-start items-start">
        ...
        className={getButtonStyles(activeModal === 'logout')}>
          <div className="w-6 h-6 flex items-center justify-center">
        ...
        className={getButtonStyles(activeModal === 'withdraw')}>
           <div className="w-6 h-6 flex items-center justify-center">
